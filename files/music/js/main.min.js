      ...
      update: {
        ...
        updateSlides: function () {
          ...
          for (let i = 0; i < p; i += 1) {
            ...
            const n = c.eq(i);
            if (
              ($ && e.grid.updateSlide(i, n, p, t), 'none' !== n.css('display'))
            ) {
              if ('auto' === a.slidesPerView) {
                ...
                (C = (r - (a.slidesPerView - 1) * x) / a.slidesPerView),
                  a.roundLengths && (C = Math.floor(C)),
          ...
          if (
            ...
            $ && e.grid.updateWrapperSize(C, u, t),
            !a.centeredSlides)
          ) {
            const t = [];
      ...
      transition: {
        ...
        transitionStart: function (e = !0, t) {
          ...
          a.cssMode ||
            ...
            C({ swiper: s, runCallbacks: e, direction: t, step: 'Start' }));
        },
        transitionEnd: function (e = !0, t) {
          ...
          (s.animating = !1),
            a.cssMode ||
              (s.setTransition(0),
              C({ swiper: s, runCallbacks: e, direction: t, step: 'End' }));
        }
      },
      slide: {
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = S.bind(e)),
            ...
            (e.onClick = z.bind(e)),
            i.touch && !O && (t.addEventListener('touchstart', I), (O = !0)),
            A(e, 'on');
        },
  ...
  const J = [
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: a }) {
      ...
      function c() {
        ...
        if (
          ('fraction' === s.type &&
            (c.find(Y(s.currentClass)).text(s.formatFractionCurrent(p + 1)),
            c.find(Y(s.totalClass)).text(s.formatFractionTotal(u))),
          'progressbar' === s.type)
        ) {
          let t;
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      function h(t) {
        ...
        e.navigation &&
          ...
          e.pagination &&
            a.is(Y(e.params.pagination.bulletClass)) &&
            a[0].click();
      }
      function m() {
    ...
    function ({ swiper: e }) {
      Object.assign(e, {
        appendSlide: V.bind(e),
        prependSlide: q.bind(e),
        addSlide: W.bind(e),
        removeSlide: R.bind(e),
        removeAllSlides: j.bind(e)
      });
    },
    function ({ swiper: e, extendParams: t, on: s }) {
...
const $timer = document.querySelector('.timer'),
  ...
  $menuList = $header.querySelector('.header__nav'),
  $menuBtn = $header.querySelector('.header__menu-btn'),
  $eventContainer = document.querySelector('.events'),
  $tabs = $eventContainer.querySelector('.events__tabs'),
  $tabTables = $eventContainer.querySelectorAll('[data-type="tab-content"]');
function menuHandle(e) {
  const t = e.target,
    s = t.closest('[data-type="header-link"]');
  (t.closest('[data-type="header-menu-btn"]') || s) &&
    ($menuBtn.classList.toggle('header__menu-btn--active'),
    $menuList.classList.toggle('header__nav--active')),
    $menuBtn.classList.contains('header__menu-btn--active')
...
function countdownTimer() {
  const e =
    ...
    new Date();
  e <= 0 && clearInterval(timerId);
  const t = e > 0 ? Math.floor(e / 1e3 / 60 / 60 / 24) : 0,
    s = e > 0 ? Math.floor(e / 1e3 / 60 / 60) % 24 : 0,
    a = e > 0 ? Math.floor(e / 1e3 / 60) % 60 : 0,
    i = e > 0 ? Math.floor(e / 1e3) % 60 : 0;
  ($days.textContent = (t < 10 ? '0' + t : t) + 'd'),
    ($hours.textContent = (s < 10 ? '0' + s : s) + 'h'),
    ($minutes.textContent = (a < 10 ? '0' + a : a) + 'm'),
    ($seconds.textContent = (i < 10 ? '0' + i : i) + 's'),
    ($days.dataset.title = declensionNum(t, ['день', 'дня', 'дней'])),
    ($hours.dataset.title = declensionNum(s, ['час', 'часа', 'часов'])),
    ($minutes.dataset.title = declensionNum(a, ['минута', 'минуты', 'минут'])),
    ($seconds.dataset.title = declensionNum(i, [
      'секунда',
      'секунды',
      'секунд'
    ]));
}
function declensionNum(e, t) {
  return t[
    e % 100 > 4 && e % 100 < 20
      ? 2
...
function tabHandle(e) {
  const t = e.target.closest('[data-type="tab"]'),
    s = 'events__tab--active';
  if (null === t) return;
  if (t.classList.contains(s)) return;
  $tabs.querySelector('.' + s).classList.remove(s),
    t.classList.add(s),
    selectTabContent(t.getAttribute('data-tab-name'));
}
function selectTabContent(e) {
  $tabTables.forEach((t) => {
    t.getAttribute('data-tab-content') === e
      ? t.classList.add('events__table--active')
      : t.classList.remove('events__table--active');
  });
}
function init() {
  $header.addEventListener('click', menuHandle),
    $tabs.addEventListener('click', tabHandle),
    timerHandle();
}
document.addEventListener('DOMContentLoaded', init),
  new Swiper('.categories__swiper', {
    ...
    breakpoints: {
      ...
      370: { slidesPerView: 1.4, spaceBetween: 10 },
  ...
  new Swiper('.best-shots__swiper', {
    ...
    simulateTouch: !1,
    navigation: {
      nextEl: '.best-shots__slider-button-next',
      prevEl: '.best-shots__slider-button-prev'
    },
    breakpoints: {
      320: { slidesPerView: 1.1 },
      780: { slidesPerView: 2.4, spaceBetween: 15 },
      900: { slidesPerView: 3.6, simulateTouch: !0 },
